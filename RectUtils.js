...
export function calculateSizeForZoomScale(
  viewportSize,
  imageSize,
  maximumZoom,
  zoomScale,
  ...
  // zoom = 1
  const maxWidth = viewportSize.width / zoomScale;
  const maxHeight = viewportSize.height / zoomScale;
  const frame = { width: maxWidth, height: maxHeight };
